...
[\textcolor{Black}{\textbf{бз}}]}\textcolor{Black}{\textbf{цел}}|\textcolor{Black}{\textbf{бз8}}|\textcolor{Black}{\textbf{бз16}}|\textcolor{Black}{\textbf{бз32}}|\textcolor{Black}{\textbf{бз64}}|\\
...
\begin{center}
\noindent\textcolor{Green}{\syntax{(\{\textcolor{Black}{\textbf{бол}}\}|\{\textcolor{Black}{\textbf{мал}}\})}\textcolor{Black}{\textbf{вещ}}|\textcolor{Black}{\textbf{вещ32}}|\textcolor{Black}{\textbf{вещ64}}|\textcolor{Black}{\textbf{вещ80}}|\textcolor{Black}{\textbf{вещ128}}}
\end{center}
...
\begin{center}
\noindent\textcolor{Green}{\syntax{(\{\textcolor{Black}{\textbf{бол}}\}|\{\textcolor{Black}{\textbf{мал}}\})}\textcolor{Black}{\textbf{компл}}|\textcolor{Black}{\textbf{компл32}}|\textcolor{Black}{\textbf{компл64}}|\textcolor{Black}{\textbf{компл80}}|\textcolor{Black}{\textbf{компл128}}}
\end{center}
...
\begin{center}
\noindent\textcolor{Green}{\textcolor{Black}{\textbf{фун}} \synt{сигнатура} }
\end{center}
...
%\begin{center}
%\noindent\textcolor{Green}{\syntax{\textcolor{Black}{\textbf{множество}} \textcolor{Black}{(}
%(\synt{элемент множества})\{\textcolor{Black}{,}(\synt{элемент множества})\}\textcolor{Black}{)}}}
%\end{center}	
...
\begin{Example}\\
\rm
\hspace*{4mm} \textbf{тип} A = \textbf{множество}(jan, feb, mar, apr, may, jun, jul, aug, sep, oct, nov, dec);\\
...
\rm 	
\hspace*{5mm} \textbf{тип} \texttt{C} = \textbf{множество}(anna, elena, conya, gelya, liza, mary, sveta, sasha);\\
...
Тогда результатом A + B является множество имён тех девушек, которые или занимаются спортом, или хороши в искусстве, или и спортивны, и рисуют. В это множество войдут anna, conya, liza, mary, sveta, sasha.

Результатом A * B является множество, в которое входят имена спортивных и творческих девушек, т.е. anna, mary, sveta.

Наконец, результатом A -- B является множество имён девушек, которые спортивны, но не занимаются рисованием. Это conya и sasha.
...
Следовательно,
\begin{flushleft}
\hspace*{5mm} liza \textbf{в} B \\
\hspace*{5mm} даёт в результате true, а \\
\hspace*{5mm} gelya \textbf{в} (A + B) \\
...
%
\indent\synt{опр_структуры}$\to$\textcolor{Black}{\textbf{структ}} \synt{имя_структуры} \textcolor{Black}{\{}\synt{тело_структуры}\textcolor{Black}{\}}\\
%
...
\textcolor{Green}{%
\syntax{%
\synt{описание_функции}$\to$[\textcolor{Black}{\textbf{глав}}|\textcolor{Black}{\textbf{чистая}}] \textcolor{Black}{\textbf{фун}} \synt{имя_функции} %
...
(\textcolor{Black}{\textbf{выдел}}|\textcolor{Black}{\textbf{очищ}})%\\
...
\synt{вещественное}|\synt{комплексное}|\textcolor{Black}{\textbf{истина}}|\textcolor{Black}{\textbf{ложь}}|\textcolor{Black}{\textbf{ничего}}|\synt{имя}|%
...
\{\textcolor{Black}{\textbf{иначеесли}}\textcolor{Black}{\texttt{(}}\synt{условие}\textcolor{Black}{\texttt{)}}\textcolor{Black}{\textbf{то}}%\\
\textcolor{Black}{\texttt{\{}} \{\synt{описание}|\synt{операторы}\} \textcolor{Black}{\texttt{\}}}\}\\
...
\textcolor{Green}{\syntax{\textcolor{Black}{\textbf{иначеесли}}\textcolor{Black}{\texttt{(}}\synt{условие}\textcolor{Black}{\texttt{)}}\textcolor{Black}{\textbf{то}}%\\
...
\textcolor{Black}{\textbf{повт}}\textcolor{Black}{\texttt{\{}} \{\synt{описание}|\synt{операторы}\} \textcolor{Black}{\texttt{\}}}%
\textcolor{Black}{\textbf{пока}}\textcolor{Black}{\texttt{(}}\synt{условие}\textcolor{Black}{\texttt{)}} }}
\end{center}
Здесь \textcolor{Green}{\syntax{\synt{условие}}} --- это логическое выражение, а  \textcolor{Green}{\syntax{\synt{имя_цикла}}} --- идентификатор, являющийся именем цикла.
...
\begin{center}
\textcolor{Green}{\syntax{[\textcolor{Black}{\texttt{+|}}\synt{имя_цикла}\textcolor{Black}{\texttt{:}}]%
\textcolor{Black}{\textbf{бескон}} \textcolor{Black}{\textbf{повт}}\textcolor{Black}{\texttt{\{}} \{\synt{описание}|\synt{операторы}\} \textcolor{Black}{\texttt{\}}} }}
\end{center}
...
\phantom{конец}\textcolor{Black}{\texttt{\}}}\\
\textcolor{Black}{\texttt{\}}}\\
\textcolor{Black}{\textbf{иначеесли}}\textcolor{Black}{\texttt{(}}\textcolor{Black}{t$_3$} \textcolor{Black}{\texttt{<}} \textcolor{Black}{0}\textcolor{Black}{\texttt{)}}%
\textcolor{Black}{\textbf{то}}\\
\textcolor{Black}{\texttt{\{}}\\
\phantom{конец}\synt{v} \textcolor{Black}{\texttt{:=}} \textcolor{Black}{t$_1$}\textcolor{Black}{;}\\
\phantom{конец}\textcolor{Black}{\textbf{пока}}\textcolor{Black}{\texttt{(}}\synt{v} \textcolor{Black}{\texttt{>=}} \textcolor{Black}{t$_2$}\textcolor{Black}{\texttt{)}}\\
